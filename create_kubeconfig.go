...
func (k *KubeConfig) NewKubeConfigForRESTConfig(config *rest.Config) ([]byte, error) {
	kubeConfig := KubeConfigValue{
		Clusters: []KubeconfigNamedCluster{
			{
				Name: "giantswarm-autogenerated-cluster-name",
		...
		Contexts: []KubeconfigNamedContext{
			{
				Name: "giantswarm-autogenerated-context-name",
				Context: KubeconfigContext{
					Cluster: "giantswarm-autogenerated-context-name",
					User:    "giantswarm-autogenerated-user-name",
				},
			},
		},
		Users: []KubeconfigUser{
			{
				Name: "giantswarm-autogenerated-user-name",
